export function Gallery() {
  const images = [
    ...
    { src: "/1513-dining4.jpg", alt: "Reception Hall" },
    { src: "/the-venue7.jpg", alt: "Couple Portrait" },
    { src: "/1513-venue-cross.jpg", alt: "Table Settings" },
    { src: "/1513-spaces4.jpg", alt: "Sunset Views" },
    { src: "/1513-venue-cross2.jpg", alt: "Gardens" },
  ]
